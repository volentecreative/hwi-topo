...
<script src="https://cdn.jsdelivr.net/gh/volentecreative/hwi-topo@92638a0/drone-hero.js"></script>
...
from the style panel, e.g. `left: calc(50% + var(--drone-progress, 0) * 25%)`. `exitVar` (`--drone-exit`) is a second
