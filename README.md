...
reaches its window, `drone:unreach` on the way back up past it); the camera passes through the pose at the window's centre (or the pose's `at`), and a
...
<script src="https://cdn.jsdelivr.net/gh/volentecreative/hwi-topo@81fc94d/drone-hero.js"></script>
